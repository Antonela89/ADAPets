...
const SERVICES = [
  {
    ...
    description: "Atención integral y diagnósticos precisos para el bienestar de tu mascota en cada etapa de su vida.",
    image: "https://images.unsplash.com/photo-1628009368231-7bb7cfcb0def?w=900&auto=format&fit=crop",
    className: "col-span-1 sm:col-span-2 lg:col-span-2 lg:row-span-2 min-h-[380px] lg:min-h-[480px]",
    badge: "+500 pacientes",
  },
  {
    icon: FaSyringe,
    title: "Vacunación",
    description: "Esquemas completos para proteger a tu compañero de enfermedades.",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=600&auto=format&fit=crop",
    className: "col-span-1 min-h-[260px]",
    badge: null,
  },
  {
    ...
    description: "Baño, corte y cuidado estético para que tu mascota luzca increíble y se sienta de maravilla.",
...
const ServiceCard = ({ icon: Icon, title, description, image, className, badge, index }) => (
  <motion.article
  ...
  >
    ...
    <div className="relative z-10 flex flex-col justify-end h-full p-6">
      ...
      <p className="font-quicksand text-sm leading-relaxed text-white/85">{description}</p>
    </div>
  </motion.article>
);
...
const Services = () => (
  <section id="services" className="relative py-24 px-4 md:px-8">
    <div className="relative z-10 max-w-6xl mx-auto">
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold font-fredoka text-vet-primary mb-4">
          Nuestros <span className="text-vet-dark/80">Servicios</span>
        </h2>
        <p className="font-quicksand text-lg max-w-2xl mx-auto text-vet-surface/80">
          Atención de calidad con amor y dedicación para la salud y felicidad de tu mejor compañero.
        </p>
      </motion.div>
