    ...
    <section className="relative h-screen w-full flex items-center overflow-hidden bg-vet-bg">
      ...
      <div className="relative z-20 container px-6 md:px-16">
        <div className="flex flex-col items-start max-w-xl">
          <h1
            className="text-vet-primary text-5xl sm:text-7xl md:text-8xl lg:text-9xl mb-6 animate-reveal"
            style={{
          ...
          <div className="relative overflow-hidden pt-4 mb-4">
            <div className="h-[3px] w-16 bg-vet-accent absolute top-0 left-0 animate-line-grow" />
            <p className="text-vet-text text-xl md:text-3xl lg:text-4xl animate-fade-in-up">
              Tu Cuidado{" "}
          ...
          <p className="text-vet-text-muted/80 text-base md:text-lg max-w-sm animate-fade-in-up delay-200">
          ...
          <div className="mt-12 md:mt-24 animate-fade-in-up delay-300">
            <button
              ...
              className="
                ...
                hover:bg-vet-accent-hover/80
                hover:scale-[1.04]
                hover:shadow-[0_16px_40px_rgba(233,128,116,0.45)]
                dark:hover:shadow-[0_16px_40px_rgba(243,156,146,0.45)]
                active:scale-95
              "
            >
